package com.colglaze.yunpicture.manager.auth.servers;
...
import com.colglaze.yunpicture.manager.auth.model.SpaceUserAuthContext;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (space.getSpaceType() == SpaceTypeEnum.PRIVATE.getValue()) {
            // 私有空间，仅本人或管理员有权限
            if (space.getUserId().equals(userId) || StrUtil.equals(loginUser.getUserRole(), UserConstant.ADMIN_ROLE)) {
                return ADMIN_PERMISSIONS;
            } else {
                return new ArrayList<>();
            }
